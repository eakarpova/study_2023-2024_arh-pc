...
![Создание директории](image/1){#fig:001 width=100%}
...
![Создание копии файла](image/2){#fig:002 width=100%}

Открываю созданный файл и вставляю в него программу вывода значения регистра eax (рис. @fig:003).

![Редактирование файла](image/3){#fig:003 width=100%}
...
![Запуск исполняемого файла](image/4){#fig:004 width=100%}

Изменяю в тексте программы символы "6" и "4" на цифры 6 и 4(рис. @fig:005).

![Замена символов в файле](image/5){#fig:005 width=100%}
...
![Запуск исполняемого файла](image/8){#fig:008 width=100%}

Заменяю в тексте программы символы "6" и "4" на числа 6 и 4(рис. @fig:009).

![Замена символов на числа](image/9){#fig:009 width=100%}
...
![Запуск исполняемого файла](image/10){#fig:010 width=100%}

Заменяю в текст программы функцию iprintLF на iprint(рис. @fig:011).

![Редактирование файла](image/11){#fig:011 width=100%}
...
![Запуск исполняемого файла](image/18){#fig:018 width=100%}
...
![Создание нового файла](image/19){#fig:019 width=100%}
